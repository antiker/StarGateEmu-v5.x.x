...
void WorldSession::HandleCalendarAddEvent(WorldPacket &recv_data)
{
    ...
    calendar_event.id = sCalendarMgr->GetNextEventID();
    calendar_event.name = title;
    calendar_event.description = description;
    calendar_event.type = type;
    calendar_event.unk = unkbyte;
    calendar_event.dungeonID = dungeonId;
    calendar_event.flags = flags;
    calendar_event.time = eventPackedTime;
    calendar_event.unkTime = unkPackedTime;
    calendar_event.creator_guid = GetPlayer()->GetGUID();

    sCalendarMgr->AddEvent(calendar_event);
    ...
    SendCalendarEvent(sCalendarMgr->GetNextEventID(),true);
